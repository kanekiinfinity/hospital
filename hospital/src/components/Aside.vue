    ...
    <div>
        <div class="max-w-64 flex flex-col">
            ...
            <ul class="px-6 ">
                ...
                <li class="py-3">
                    <a class="flex items-center gap-3" href="">
                        <img class="w-4 h-4" src="../assets/img/doc-item.svg" alt="">
                        <h3 class="text-[#336CFB] font-lato text-sm font-bold leading-5 tracking-[0.1px]">Palatalar</h3>
                    </a>
                </li class="py-3">
                <li class="py-3">
                    <a class="flex items-center gap-3" href="">
                        <img class="w-4 h-4" src="../assets/img/doc-icon.svg" alt="">
                        <h3 class="text-sm font-lato font-bold leading-5 tracking-[0.1px]">Shifokorlar</h3>
                    </a>
                </li>
                <li class="py-3">
                    <a class="flex items-center gap-3" href="">
                        <img class="w-4 h-4" src="../assets/img/patiant.svg" alt="">
                        <h3 class="text-sm font-lato font-bold leading-5 tracking-[0.1px]">Bo'limlar</h3>
                    </a>
                </li>
                <li class="py-3 pb-[22px]">
                    <a class="flex items-center gap-3" href="">
                        <img class="w-4 h-4" src="../assets/img/invalid.svg" alt="">
                ...
                <li class="py-3 pt-[22px]">
                    <a class="flex items-center gap-3" href="">
                        ...
                        <h3 class="text-sm font-lato font-bold leading-5 tracking-[0.1px]">Yordam</h3>
                    </a>
                </li>
            </ul>
        </div>
